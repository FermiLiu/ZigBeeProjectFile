...
char goods_Name[8][20] = {"", "apple", "orange", "banana", "pear", "kiwi", "mango", "pitaya"};
...
//	fprintf (cgiOut, "<h5>物品数量:\t%d</H5>\n ", info_CGI.storage_no[STORAGE_NO].goods_info[GOODSKINDS_2].goods_count);
	fprintf (cgiOut, "<h5>物品名称:\t%s\t%s\t%s</H5>\n ", goods_Name[1],goods_Name[2], goods_Name[3]);
	fprintf (cgiOut, "<h5>物品数量:\t%d\t%d\t%d</H5>\n ", info_CGI.storage_no[STORAGE_NO].goods_info[GOODSKINDS_1].goods_count, info_CGI.storage_no[STORAGE_NO].\
			goods_info[GOODSKINDS_2].goods_count, info_CGI.storage_no[STORAGE_NO].goods_info[GOODSKINDS_3].goods_count);

	fprintf (cgiOut, "<h5>物品名称:\t%s\t%s\t%s\t%s</H5>\n ",goods_Name[4], goods_Name[5],goods_Name[6],goods_Name[7]);
	fprintf (cgiOut, "<h5>物品数量:\t%d\t%d\t%d\t%d</H5>\n ",info_CGI.storage_no[STORAGE_NO].goods_info[GOODSKINDS_4].goods_count,info_CGI.storage_no[STORAGE_NO].goods_info[GOODSKINDS_5].goods_count,info_CGI.storage_no[STORAGE_NO].goods_info[GOODSKINDS_6].goods_count,info_CGI.storage_no[STORAGE_NO].goods_info[GOODSKINDS_7].goods_count);
